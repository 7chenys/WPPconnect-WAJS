...
本仓库是 [WPPConnect WA-JS](https://github.com/wppconnect-team/wa-js) 的固定版本快照。当前下游已发布版本为 `4.6.1`，待发布版本为 `4.6.2`，源码基线对应上游版本 `4.6.0`。
...
当前工作树包含一项尚未作为上游官方合并发布的建群兼容性补丁。补丁范围、上游 PR 关系及明确排除的改动见 [RELEASE-NOTES.md](./RELEASE-NOTES.md)。
...
```bash
npm install @yanmontain/wa-js@4.6.1 --save-exact
```
...
{
  "dependencies": {
    "@wppconnect/wa-js": "npm:@yanmontain/wa-js@4.6.1"
  }
}
```
